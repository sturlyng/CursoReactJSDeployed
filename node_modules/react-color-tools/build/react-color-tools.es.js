...
var Container = function Container(_ref) {
  ...
  return React.createElement(
    'div',
    {
      className: css(_templateObject$2, width, background)
    },
    children
  );
};
...
var Image = function Image(_ref) {
  ...
  return React.createElement('img', _extends({ src: src, alt: '', style: { width: '228px', height: '110px' } }, rest));
};
...
var StyledSVG = styled('svg')(_templateObject$8);

var ToolsSVG = styled('svg')(_templateObject2$2);
...
var createStyledSVG = function createStyledSVG(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement('path', { fill: color, d: d })
  );
};
...
var ColorSaturator = HOC(function (_ref) {
  ...
  return React.createElement(
    StyledSpan,
    { title: 'color saturator' },
    React.createElement(SaturatorIcon, { width: 20, height: 20, color: color }),
...
var ColorDesaturator = HOC(function (_ref2) {
  ...
  return React.createElement(
    StyledSpan,
    { title: 'color desaturator' },
    React.createElement(DesaturatorIcon, { width: 20, height: 20, color: color }),
    React.createElement(Slider, {
      min: '10',
      max: '100',
      value: value,
...
var ColorBrightener = HOC(function (_ref3) {
  ...
  return React.createElement(
    StyledSpan,
    { title: 'color brightener' },
    React.createElement(ColorBrightenerIcon, { width: 20, height: 20, color: color }),
    React.createElement(Slider, {
      min: '10',
      max: '100',
      value: value,
...
var ColorDarkener = HOC(function (_ref4) {
  ...
  return React.createElement(
    StyledSpan,
    { title: 'color darkener' },
    React.createElement(ColorDarkenerIcon, { width: 16, height: 16, color: color }),
    React.createElement(Slider, {
      min: '10',
      max: '100',
      value: value,
...
var ColorSpinner = HOC(function (_ref5) {
  ...
  return React.createElement(
    StyledSpan,
    { title: 'color spin' },
    React.createElement(ColorSpinIcon, { width: 18, height: 18, color: color }),
    React.createElement(Slider, {
      min: '-360',
      max: '360',
      value: value,
...
var ImagePicker = HOC(function (_ref6) {
  ...
  return React.createElement(
    ...
    React.createElement(ImagePickerIcon, { id: 'image-icon', height: 20, width: 20, color: color })
  );
});
...
var PaletteGenerator = HOC(function (_ref7) {
  ...
  return React.createElement(
    ...
    React.createElement(SwatchesGeneratorIcon, { width: 21, height: 21, color: color })
  );
});
...
var ShadesGenerator = HOC(function (_ref8) {
  ...
  return React.createElement(
    ...
    React.createElement(ShadesGeneratorIcon, { height: 20, width: 20, color: color })
  );
});
...
var Reset = HOC(function (_ref9) {
  ...
  return React.createElement(
    ...
    React.createElement(ResetIcon, { height: 18, width: 17.5, color: color })
  );
});
...
var TintsGenerator = HOC(function (_ref10) {
  ...
  return React.createElement(
    ...
    React.createElement(TintsGeneratorIcon, { height: 21, width: 21, color: color })
  );
});
...
var Clipboard = HOC(function (_ref11) {
  ...
  return React.createElement(
    ...
    React.createElement(ClipboardIcon, { height: 18, width: 19, color: color })
  );
});
...
var GradientGenerator = HOC(function (_ref12) {
  ...
  return React.createElement(
    ...
    React.createElement(GenerateGradientIcon, { height: 20, width: 17.5, color: color })
  );
});
...
var StyledList = styled('ul')(_templateObject$a);

var ToolsContainer = styled('div')(_templateObject2$4, function (props) {
...
var BasicPicker = function (_React$PureComponent) {
  ...
  BasicPicker.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      this.props.triangle && image === null && React.createElement(Triangle, { color: this.state.color.toHexString() }),
      image === null ? React.createElement(ColorBlock, {
        colorState: this.state.color,
        color: color,
        currentFormat: currentFormat
      }) : React.createElement(Image, { src: image }),
      image && React.createElement(ColorExtractor, {
      ...
      React.createElement(
        'div',
        { style: { padding: 10 } },
        showShades ? React.createElement(Swatches, {
          swatches: shades,
          updateSwatch: this.updateSwatch,
          onSwatchHover: this.props.onSwatchHover
        }) : showTints ? React.createElement(Swatches, {
          swatches: tints,
          updateSwatch: this.updateSwatch,
          onSwatchHover: this.props.onSwatchHover
        ...
        React.createElement(
          ...
          React.createElement(
            ToolsContainer,
            null,
            React.createElement(BasicTools.ImagePicker, { uploadImage: this.uploadImage }),
            React.createElement(BasicTools.PaletteGenerator, {
              generateSwatches: this.generateSwatches
            }),
            React.createElement(BasicTools.TintsGenerator, { generateTints: this.generateTints }),
            ...
            React.createElement(BasicTools.Reset, { resetColors: this.resetColors })
          )
        ),
        this.props.showTools ? React.createElement(
          'div',
          null,
          React.createElement(
            Provider,
...
var StyledLabel$1 = styled('label')(_templateObject$b, function (props) {
  return props.color;
});
...
var ColorBlock$1 = function ColorBlock(_ref) {
  ...
  return React.createElement('div', {
    className: css$1(_templateObject2$5),
  ...
  return React.createElement(
    ...
    function (color) {
      return React.createElement(
        'div',
        null,
        React.createElement(ColorInputField, { value: inputColor, onChange: onChangeColor }),
        React.createElement(
          'span',
          null,
          React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            {
              className: css$1(_templateObject3)
            },
            React.createElement(BasicTools.Clipboard, {
...
var Swatch$1 = function Swatch(_ref) {
  var color = _ref.color,
      updateSwatch = _ref.updateSwatch;
  return React.createElement('div', {
    className: css(_templateObject$c, color),
...
var CompactSwatches = function CompactSwatches(_ref2) {
  ...
  return React.createElement(
    'div',
    {
      className: css(_templateObject2$6)
    },
    schemes.map(function (scheme) {
      return React.createElement(Swatch$1, { updateSwatch: updateSwatch, color: scheme, key: scheme });
    })
  );
};
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            {
              className: css(_templateObject$d)
            },
            React.createElement(BasicTools.Clipboard, {
